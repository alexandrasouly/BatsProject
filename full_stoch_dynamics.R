...
/* ------------------------------ juvenile transitions: ------------------------------------------------------ */  
  ...
  double probs_Sj_out[4] = {r_juv_death/r_Sj_out, r_J_A/(2*r_Sj_out), r_J_A/(2*r_Sj_out), r_S_I/r_Sj_out};
  double probs_Ej_out[4] = {r_juv_death/r_Ej_out, r_J_A/(2*r_Ej_out), r_J_A/(2*r_Ej_out), r_E_I/r_Ej_out};
  double probs_Ij_out[5] = {r_juv_death/r_Ij_out, r_J_A/(2*r_Ij_out), r_J_A/(2*r_Ij_out), r_I_R/r_Ij_out, r_I_E/r_Ij_out};
  double probs_Rj_out[4] = {r_juv_death/r_Rj_out, r_J_A/(2*r_Rj_out), r_J_A/(2*r_Rj_out), r_R_S/r_Rj_out};
...
/* --- rates of changing state --- */
  ...
  double probs_Sm_out[2] = {r_death/r_Sm_out, r_S_I/r_Sm_out};
  double probs_Em_out[2] = {r_death/r_Em_out, r_E_I/r_Em_out};
  double probs_Im_out[3] = {r_death/r_Im_out, r_I_R/r_Im_out, r_I_E/r_Im_out};
  double probs_Rm_out[2] = {r_death/r_Rm_out, r_R_S/r_Rm_out};
...
/* --- rates of changing state --- */
  ...
  double probs_Sf_out[2] = {r_death/r_Sf_out, r_S_I/r_Sf_out};
  double probs_Ef_out[2] = {r_death/r_Ef_out, r_E_I/r_Ef_out};
  double probs_If_out[3] = {r_death/r_If_out, r_I_R/r_If_out, r_I_E/r_If_out};
  double probs_Rf_out[2] = {r_death/r_Rf_out, r_R_S/r_Rf_out};
