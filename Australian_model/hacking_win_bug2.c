/* pomp C snippet file: hacking_win_bug2 */
/* Time: 2020-08-04 23:28:17.653 +0200 */
/* Salt: FC56B38ACD01857B6043F78B */
...
void R_init_hacking_win_bug2 (DllInfo *info)
{
R_RegisterCCallable("hacking_win_bug2", "__pomp_load_stack_incr", (DL_FUNC) __pomp_load_stack_incr);
R_RegisterCCallable("hacking_win_bug2", "__pomp_load_stack_decr", (DL_FUNC) __pomp_load_stack_decr);
R_RegisterCCallable("hacking_win_bug2", "__pomp_rinit", (DL_FUNC) __pomp_rinit);
R_RegisterCCallable("hacking_win_bug2", "__pomp_stepfn", (DL_FUNC) __pomp_stepfn);
R_RegisterCCallable("hacking_win_bug2", "__pomp_rmeasure", (DL_FUNC) __pomp_rmeasure);
R_RegisterCCallable("hacking_win_bug2", "__pomp_dmeasure", (DL_FUNC) __pomp_dmeasure);
R_RegisterCCallable("hacking_win_bug2", "__pomp_to_trans", (DL_FUNC) __pomp_to_trans);
R_RegisterCCallable("hacking_win_bug2", "__pomp_from_trans", (DL_FUNC) __pomp_from_trans);
R_RegisterCCallable("hacking_win_bug2", "__pomp_skelfn", (DL_FUNC) __pomp_skelfn);
}
