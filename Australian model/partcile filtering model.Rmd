...
We use the 2019 Clunes data. We calculate conditional likelihood of SIR with no seasonal forcing at Aaron's posterior parameter values (model 5). We take m, mj, mu and kappa as fixed
```{r}
...
We replicate it 10 times. Then we evaluate the log-likelihood at the result values witha particle filter.
```{r}
