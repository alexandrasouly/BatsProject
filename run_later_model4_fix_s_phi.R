...
guesses <-  rbind(guesses, model_4_params, model_4_params,
                  model_4_params, model_4_params, model_4_params)
...
mf3<- foreach(guess=iter(guesses,"row"),
  ...
  {   mif2(
    ...
    rw.sd=rw.sd(R0=0.02, zeta=0.02, rho_val = 0.02, epsilon_val = 0.02,
