pomp_model_fn_inter_season <-function(site, year, init_states, input_params){
...
source("stoch_step_inter_season.R", local = TRUE)
stochStep <-stochStep()

# deterministic skeleton
source("det_model_skeleton_inter_season.R", local = TRUE)
...
source("ini_and_params_inter_season.R", local = TRUE)
state_names <- states()
param_names <- params()
