---
title: "Estimating how much minimal burn-in I need"
...
samplesize_dat <- rbind(c("time" = -365*50+1, "samplesize" = 0 ), samplesize_dat)
...
sim <- simulate(pomp_object,params=params,format = "data.frame", nsim = 100, times = seq(-365*12+1, 1083))
x<-trajectory(pomp_object,params=params,format="d", times = seq(-365*12+1, 1083))
...
```
  12 years of burn-in seems enough!
